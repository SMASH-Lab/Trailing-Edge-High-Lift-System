...
<tr><td valign=\"top\">Satisfied</td>
 ...
 type CumulatedProperty = enumeration(
      Violated
              "At least one property is violated since start of simulation",
      Untested
              "No property is tested since start of simulation",
      Satisfied
               "At least one property is successfully tested since start of simulation (and no one is violated)")
    "Enumeration defining literals for three-valued logic for accumulated properties"
                                                                         annotation (
       Documentation(info="<html>
<p>
Enumeration defining literals for three-valued logic to model properties and requirements
